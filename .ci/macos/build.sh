...
cmake -GNinja -S. -Bbuild \
      ...
      -DCMAKE_INSTALL_PREFIX="mheko.temp" \
...
(
    ...
    cp libqtjdenticon.dylib ../../mheko.temp/mheko.app/Contents/MacOS
    # "$(brew --prefix qt6)/bin/macdeployqt" mheko.app -always-overwrite -qmldir=../resources/qml/
    # # workaround for https://bugreports.qt.io/browse/QTBUG-100686
    # cp "$(brew --prefix brotli)/lib/libbrotlicommon.1.dylib" mheko.app/Contents/Frameworks/libbrotlicommon.1.dylib
)

mv mheko.temp/mheko.app mheko.app
